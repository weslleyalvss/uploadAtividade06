...
public class Notebook implements Processador, Aparelho, Bateria {
	...
	public void carregar() {
		System.out.println("Notebook carregado!");
	...
	public String toString() {
		return "Notebook [carregado=" + carregado + ", porcentagem=" + porcentagem + ", marca=" + marca
				+ "]";
	}
